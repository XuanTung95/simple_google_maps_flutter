...
import 'simple_google_map_inspector_android.dart';
...
class SimpleGoogleMapsFlutterAndroid extends GoogleMapsFlutterPlatform {
  /// Registers the Android implementation of GoogleMapsFlutterPlatform.
  static void registerWith() {
    if (Platform.isAndroid) {
      GoogleMapsFlutterPlatform.instance = SimpleGoogleMapsFlutterAndroid.instance;
    }
  }

  static final SimpleGoogleMapsFlutterAndroid _instance = SimpleGoogleMapsFlutterAndroid._();
  static SimpleGoogleMapsFlutterAndroid get instance {
    return _instance;
  }

  SimpleGoogleMapsFlutterAndroid._();
