...
//
// import 'simple_google_map_inspector_ios.dart';
//
...
// class UnknownMapIDErrorIOS extends Error {
//   /// Creates an assertion error with the provided [mapId] and optional
//   /// [message].
//   UnknownMapIDErrorIOS(this.mapId, [this.message]);
//
//   /// The unknown ID.
//   final int mapId;
//
...
// class SimpleGoogleMapsFlutterIOS extends GoogleMapsFlutterPlatform {
//   /// Registers the iOS implementation of GoogleMapsFlutterPlatform.
//   static void registerWith() {
//     if (Platform.isIOS) {
//       GoogleMapsFlutterPlatform.instance = SimpleGoogleMapsFlutterIOS.instance;
//     }
//   }
//
//   static final SimpleGoogleMapsFlutterIOS _instance = SimpleGoogleMapsFlutterIOS._();
//   static SimpleGoogleMapsFlutterIOS get instance {
//     return _instance;
//   }
//
//   SimpleGoogleMapsFlutterIOS._();
//
...
//     if (channel == null) {
//       throw UnknownMapIDErrorIOS(mapId);
//     }
//     return channel;
//   }
//
